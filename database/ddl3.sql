...
CREATE OR REPLACE TABLE `potentialBuyers` (
  ...
  CONSTRAINT `fk_potentialBuyers_agents1` FOREIGN KEY (`agent_id`) REFERENCES `agents` (`agent_id`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
CREATE OR REPLACE TABLE `sellers` (
  ...
  CONSTRAINT `fk_sellers_agents1` FOREIGN KEY (`agent_id`) REFERENCES `agents` (`agent_id`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
CREATE OR REPLACE TABLE `properties` (
  ...
  CONSTRAINT `fk_properties_potentialBuyers1` FOREIGN KEY (`buyer_id`) REFERENCES `potentialBuyers` (`buyer_id`) ON DELETE SET NULL ON UPDATE NO ACTION,
